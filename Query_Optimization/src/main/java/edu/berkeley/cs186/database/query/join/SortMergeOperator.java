...
public class SortMergeOperator extends JoinOperator {
    ...
    private class SortMergeIterator implements Iterator<Record> {
        ...
        private Record fetchNextRecord() {
            ...
            if (this.leftRecord == null) { /*If next record is empty*/
                return null;
            }
            this.nextRecord = null;
            do {
                if (this.rightRecord != null && !marked) {
                    while (compare(this.leftRecord, this.rightRecord) < 0) {
                        if (!this.leftIterator.hasNext()) {
                            System.out.println("No more left records");
                    ...
                    while (compare(this.leftRecord, this.rightRecord) > 0) {
                        if (!this.rightIterator.hasNext()) {
                            System.out.println("No more right records");
                ...
                if (this.rightRecord != null && compare(this.leftRecord, this.rightRecord) == 0) {
                    ...
                    System.out.println("No merge" + count);
